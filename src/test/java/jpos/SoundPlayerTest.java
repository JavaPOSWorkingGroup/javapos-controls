...
/**
 * SoundPlayer device control JUnit test.
 * <br>
 * Generated through jpos.build.controls.JavaPOSDeviceControlTestGenerator for JavaPOS version 1.16
 */
public class SoundPlayerTest {

    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "SoundPlayerTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "SoundPlayerTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "SoundPlayerTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "SoundPlayerTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "SoundPlayerTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundPlayer", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundPlayer", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundPlayer", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundPlayer", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundPlayer", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private SoundPlayer control;

    @Before
    public void setUp() throws Exception {
        this.control = new SoundPlayer();
    }
    ...
    /**
     * Test method for {@link jpos.SoundPlayer#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS SoundPlayer Device Control"));
    }
    ...
    @Test
    public final void testGetCapMultiPlayFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapMultiPlay();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapSoundTypeListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapSoundTypeList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetDeviceSoundListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getDeviceSoundList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testPlaySoundFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.playSound("",true);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopSoundFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopSound(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapMultiPlayFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapMultiPlay();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSoundTypeListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapSoundTypeList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceSoundListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getDeviceSoundList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testPlaySoundFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.playSound("",true);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopSoundFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopSound(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMultiPlayRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapMultiPlay();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSoundTypeListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapSoundTypeList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceSoundListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getDeviceSoundList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testPlaySoundRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.playSound("",true);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopSoundRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopSound(0);
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("SoundPlayer.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapMultiPlayCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapMultiPlay();
        }
    ...
    @Test
    public void testGetCapSoundTypeListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapSoundTypeList();
        }
    ...
    @Test
    public void testGetDeviceSoundListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDeviceSoundList();
        }
    ...
    @Test
    public void testPlaySoundCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.playSound("",true);
        }
    ...
    @Test
    public void testStopSoundCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopSound(0);
        }
