...
public class CoinAcceptorTest {
    ...
    private static final String OPENNAME_ALL_METHODS_THROWING_NPE = "CoinAcceptorTestServiceAlwaysThrowingNPE";
    private static final String OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "CoinAcceptorTestServiceRethrowingJposException";
    private static final String OPENNAME_SERVICE_10 = "CoinAcceptorTestService111";
    private static final String OPENNAME_SERVICE_111 = "CoinAcceptorTestService111";
    private static final String OPENNAME_SERVICE_112 = "CoinAcceptorTestService112";
    private static final String OPENNAME_SERVICE_113 = "CoinAcceptorTestService113";
    private static final String OPENNAME_SERVICE_114 = "CoinAcceptorTestService114";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_ALL_METHODS_THROWING_NPE, "1.14"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.14"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_111, "1.11"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_112, "1.12"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_113, "1.13"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_114, "1.14"));
    }
