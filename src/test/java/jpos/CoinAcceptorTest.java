...
/**
 * CoinAcceptor device control JUnit test.
 * <br>
...
public class CoinAcceptorTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "CoinAcceptorTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "CoinAcceptorTestServiceRethrowingJposException";
    private static final String SERVICE_111 = "CoinAcceptorTestService111";
    private static final String SERVICE_112 = "CoinAcceptorTestService112";
    private static final String SERVICE_113 = "CoinAcceptorTestService113";
    private static final String SERVICE_114 = "CoinAcceptorTestService114";
    private static final String SERVICE_115 = "CoinAcceptorTestService115";
    private static final String SERVICE_116 = "CoinAcceptorTestService116";
    ...
    private static final String OPENNAME_SERVICE_111_RETURNING_VERSION_TOO_LARGE = "CoinAcceptorTestService111ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_112_RETURNING_VERSION_TOO_LARGE = "CoinAcceptorTestService112ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_113_RETURNING_VERSION_TOO_LARGE = "CoinAcceptorTestService113ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_114_RETURNING_VERSION_TOO_LARGE = "CoinAcceptorTestService114ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "CoinAcceptorTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_111, "1.11", SERVICE_111));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_112, "1.12", SERVICE_112));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_113, "1.13", SERVICE_113));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_114, "1.14", SERVICE_114));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_115, "1.15", SERVICE_115));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_111_RETURNING_VERSION_TOO_LARGE, "1.11", SERVICE_111, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_112_RETURNING_VERSION_TOO_LARGE, "1.12", SERVICE_112, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_113_RETURNING_VERSION_TOO_LARGE, "1.13", SERVICE_113, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_114_RETURNING_VERSION_TOO_LARGE, "1.14", SERVICE_114, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("CoinAcceptor", OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE, "1.15", SERVICE_115, new SimpleEntry.Prop("returnVersionTooLarge", "")));
    ...
    private CoinAcceptor control;

    @Before
    public void setUp() throws Exception {
        this.control = new CoinAcceptor();
    }
    ...
    /**
     * Test method for {@link jpos.CoinAcceptor#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS CoinAcceptor Device Control"));
    }
    ...
    public final void testGetDeviceVersion111() {
        try {
            ...
            fail("CoinAcceptor.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapDiscrepancyCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapDiscrepancy();
        }
    ...
    @Test
    public void testGetCapFullSensorCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapFullSensor();
        }
    ...
    @Test
    public void testGetCapNearFullSensorCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapNearFullSensor();
        }
    ...
    @Test
    public void testGetCapPauseDepositCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapPauseDeposit();
        }
    ...
    @Test
    public void testGetCurrencyCodeCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCurrencyCode();
        }
    ...
    @Test
    public void testSetCurrencyCodeCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setCurrencyCode("");
        }
    ...
    @Test
    public void testGetDepositAmountCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDepositAmount();
        }
    ...
    @Test
    public void testGetDepositCashListCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDepositCashList();
        }
    ...
    @Test
    public void testGetDepositCodeListCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDepositCodeList();
        }
    ...
    @Test
    public void testGetDepositCountsCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDepositCounts();
        }
    ...
    @Test
    public void testGetDepositStatusCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDepositStatus();
        }
    ...
    @Test
    public void testGetFullStatusCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getFullStatus();
        }
    ...
    @Test
    public void testBeginDepositCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.beginDeposit();
        }
    ...
    @Test
    public void testEndDepositCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.endDeposit(0);
        }
    ...
    @Test
    public void testFixDepositCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.fixDeposit();
        }
    ...
    @Test
    public void testPauseDepositCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.pauseDeposit(0);
        }
