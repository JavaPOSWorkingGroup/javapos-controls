...
public class GateTest {
    ...
    private static final String OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "GateTestServiceRethrowingJposException";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("Gate", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.14"));
