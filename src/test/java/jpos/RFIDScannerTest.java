...
/**
 * RFIDScanner device control JUnit test.
 * <br>
...
public class RFIDScannerTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "RFIDScannerTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "RFIDScannerTestServiceRethrowingJposException";
    private static final String SERVICE_112 = "RFIDScannerTestService112";
    private static final String SERVICE_113 = "RFIDScannerTestService113";
    private static final String SERVICE_114 = "RFIDScannerTestService114";
    private static final String SERVICE_115 = "RFIDScannerTestService115";
    private static final String SERVICE_116 = "RFIDScannerTestService116";
    ...
    private static final String OPENNAME_SERVICE_112_RETURNING_VERSION_TOO_LARGE = "RFIDScannerTestService112ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_113_RETURNING_VERSION_TOO_LARGE = "RFIDScannerTestService113ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_114_RETURNING_VERSION_TOO_LARGE = "RFIDScannerTestService114ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "RFIDScannerTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_112, "1.12", SERVICE_112));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_113, "1.13", SERVICE_113));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_114, "1.14", SERVICE_114));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_115, "1.15", SERVICE_115));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_112_RETURNING_VERSION_TOO_LARGE, "1.12", SERVICE_112, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_113_RETURNING_VERSION_TOO_LARGE, "1.13", SERVICE_113, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_114_RETURNING_VERSION_TOO_LARGE, "1.14", SERVICE_114, new SimpleEntry.Prop("returnVersionTooLarge", "")));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RFIDScanner", OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE, "1.15", SERVICE_115, new SimpleEntry.Prop("returnVersionTooLarge", "")));
    ...
    private RFIDScanner control;

    @Before
    public void setUp() throws Exception {
        this.control = new RFIDScanner();
    }
    ...
    /**
     * Test method for {@link jpos.RFIDScanner#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS RFIDScanner Device Control"));
    }
    ...
    @Test
    public final void testGetCapContinuousReadFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapContinuousRead();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapDisableTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapDisableTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapLockTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapLockTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapMultipleProtocolsFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapMultipleProtocols();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapReadTimerFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapReadTimer();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapWriteTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapWriteTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetContinuousReadModeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getContinuousReadMode();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCurrentTagIDFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCurrentTagID();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCurrentTagProtocolFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCurrentTagProtocol();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCurrentTagUserDataFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCurrentTagUserData();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetProtocolMaskFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getProtocolMask();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetProtocolMaskFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setProtocolMask(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetReadTimerIntervalFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getReadTimerInterval();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetReadTimerIntervalFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setReadTimerInterval(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetTagCountFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getTagCount();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testDisableTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.disableTag(new byte[0],0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testFirstTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.firstTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testLockTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.lockTag(new byte[0],0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testNextTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.nextTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testPreviousTagFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.previousTag();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testReadTagsFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartReadTagsFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopReadTagsFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopReadTags(new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testWriteTagDataFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testWriteTagIDFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapContinuousReadFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapContinuousRead();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapDisableTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapDisableTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapLockTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapLockTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMultipleProtocolsFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapMultipleProtocols();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapReadTimerFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapReadTimer();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapWriteTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapWriteTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetContinuousReadModeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getContinuousReadMode();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagIDFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCurrentTagID();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagProtocolFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCurrentTagProtocol();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagUserDataFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCurrentTagUserData();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetProtocolMaskFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getProtocolMask();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetProtocolMaskFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setProtocolMask(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetReadTimerIntervalFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getReadTimerInterval();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetReadTimerIntervalFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setReadTimerInterval(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetTagCountFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getTagCount();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testDisableTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.disableTag(new byte[0],0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testFirstTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.firstTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testLockTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.lockTag(new byte[0],0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testNextTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.nextTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testPreviousTagFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.previousTag();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testReadTagsFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartReadTagsFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopReadTagsFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopReadTags(new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testWriteTagDataFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testWriteTagIDFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapContinuousReadRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapContinuousRead();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapDisableTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapDisableTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapLockTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapLockTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMultipleProtocolsRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapMultipleProtocols();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapReadTimerRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapReadTimer();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapWriteTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapWriteTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetContinuousReadModeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getContinuousReadMode();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagIDRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCurrentTagID();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagProtocolRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCurrentTagProtocol();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCurrentTagUserDataRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCurrentTagUserData();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetProtocolMaskRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getProtocolMask();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetProtocolMaskRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setProtocolMask(0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetReadTimerIntervalRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getReadTimerInterval();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetReadTimerIntervalRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setReadTimerInterval(0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetTagCountRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getTagCount();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testDisableTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.disableTag(new byte[0],0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testFirstTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.firstTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testLockTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.lockTag(new byte[0],0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testNextTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.nextTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testPreviousTagRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.previousTag();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testReadTagsRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartReadTagsRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopReadTagsRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopReadTags(new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testWriteTagDataRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testWriteTagIDRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion112() {
        try {
            ...
            fail("RFIDScanner.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapContinuousReadCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapContinuousRead();
        }
    ...
    @Test
    public void testGetCapContinuousReadCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapContinuousRead();
        }
    ...
    @Test
    public void testGetCapContinuousReadCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapContinuousRead();
        }
    ...
    @Test
    public void testGetCapContinuousReadCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapContinuousRead();
        }
    ...
    @Test
    public void testGetCapContinuousReadCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapContinuousRead();
        }
    ...
    @Test
    public void testGetCapDisableTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapDisableTag();
        }
    ...
    @Test
    public void testGetCapDisableTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapDisableTag();
        }
    ...
    @Test
    public void testGetCapDisableTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapDisableTag();
        }
    ...
    @Test
    public void testGetCapDisableTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapDisableTag();
        }
    ...
    @Test
    public void testGetCapDisableTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapDisableTag();
        }
    ...
    @Test
    public void testGetCapLockTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapLockTag();
        }
    ...
    @Test
    public void testGetCapLockTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapLockTag();
        }
    ...
    @Test
    public void testGetCapLockTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapLockTag();
        }
    ...
    @Test
    public void testGetCapLockTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapLockTag();
        }
    ...
    @Test
    public void testGetCapLockTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapLockTag();
        }
    ...
    @Test
    public void testGetCapMultipleProtocolsCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapMultipleProtocols();
        }
    ...
    @Test
    public void testGetCapMultipleProtocolsCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapMultipleProtocols();
        }
    ...
    @Test
    public void testGetCapMultipleProtocolsCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapMultipleProtocols();
        }
    ...
    @Test
    public void testGetCapMultipleProtocolsCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapMultipleProtocols();
        }
    ...
    @Test
    public void testGetCapMultipleProtocolsCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapMultipleProtocols();
        }
    ...
    @Test
    public void testGetCapReadTimerCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapReadTimer();
        }
    ...
    @Test
    public void testGetCapReadTimerCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapReadTimer();
        }
    ...
    @Test
    public void testGetCapReadTimerCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapReadTimer();
        }
    ...
    @Test
    public void testGetCapReadTimerCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapReadTimer();
        }
    ...
    @Test
    public void testGetCapReadTimerCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapReadTimer();
        }
    ...
    @Test
    public void testGetCapWriteTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCapWriteTag();
        }
    ...
    @Test
    public void testGetCapWriteTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCapWriteTag();
        }
    ...
    @Test
    public void testGetCapWriteTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCapWriteTag();
        }
    ...
    @Test
    public void testGetCapWriteTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCapWriteTag();
        }
    ...
    @Test
    public void testGetCapWriteTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapWriteTag();
        }
    ...
    @Test
    public void testGetContinuousReadModeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getContinuousReadMode();
        }
    ...
    @Test
    public void testGetContinuousReadModeCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getContinuousReadMode();
        }
    ...
    @Test
    public void testGetContinuousReadModeCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getContinuousReadMode();
        }
    ...
    @Test
    public void testGetContinuousReadModeCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getContinuousReadMode();
        }
    ...
    @Test
    public void testGetContinuousReadModeCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getContinuousReadMode();
        }
    ...
    @Test
    public void testGetCurrentTagIDCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCurrentTagID();
        }
    ...
    @Test
    public void testGetCurrentTagIDCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCurrentTagID();
        }
    ...
    @Test
    public void testGetCurrentTagIDCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCurrentTagID();
        }
    ...
    @Test
    public void testGetCurrentTagIDCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCurrentTagID();
        }
    ...
    @Test
    public void testGetCurrentTagIDCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCurrentTagID();
        }
    ...
    @Test
    public void testGetCurrentTagProtocolCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCurrentTagProtocol();
        }
    ...
    @Test
    public void testGetCurrentTagProtocolCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCurrentTagProtocol();
        }
    ...
    @Test
    public void testGetCurrentTagProtocolCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCurrentTagProtocol();
        }
    ...
    @Test
    public void testGetCurrentTagProtocolCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCurrentTagProtocol();
        }
    ...
    @Test
    public void testGetCurrentTagProtocolCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCurrentTagProtocol();
        }
    ...
    @Test
    public void testGetCurrentTagUserDataCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getCurrentTagUserData();
        }
    ...
    @Test
    public void testGetCurrentTagUserDataCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getCurrentTagUserData();
        }
    ...
    @Test
    public void testGetCurrentTagUserDataCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getCurrentTagUserData();
        }
    ...
    @Test
    public void testGetCurrentTagUserDataCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getCurrentTagUserData();
        }
    ...
    @Test
    public void testGetCurrentTagUserDataCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCurrentTagUserData();
        }
    ...
    @Test
    public void testGetProtocolMaskCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getProtocolMask();
        }
    ...
    @Test
    public void testGetProtocolMaskCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getProtocolMask();
        }
    ...
    @Test
    public void testGetProtocolMaskCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getProtocolMask();
        }
    ...
    @Test
    public void testGetProtocolMaskCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getProtocolMask();
        }
    ...
    @Test
    public void testGetProtocolMaskCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getProtocolMask();
        }
    ...
    @Test
    public void testSetProtocolMaskCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.setProtocolMask(0);
        }
    ...
    @Test
    public void testSetProtocolMaskCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.setProtocolMask(0);
        }
    ...
    @Test
    public void testSetProtocolMaskCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.setProtocolMask(0);
        }
    ...
    @Test
    public void testSetProtocolMaskCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.setProtocolMask(0);
        }
    ...
    @Test
    public void testSetProtocolMaskCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setProtocolMask(0);
        }
    ...
    @Test
    public void testGetReadTimerIntervalCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getReadTimerInterval();
        }
    ...
    @Test
    public void testGetReadTimerIntervalCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getReadTimerInterval();
        }
    ...
    @Test
    public void testGetReadTimerIntervalCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getReadTimerInterval();
        }
    ...
    @Test
    public void testGetReadTimerIntervalCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getReadTimerInterval();
        }
    ...
    @Test
    public void testGetReadTimerIntervalCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getReadTimerInterval();
        }
    ...
    @Test
    public void testSetReadTimerIntervalCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.setReadTimerInterval(0);
        }
    ...
    @Test
    public void testSetReadTimerIntervalCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.setReadTimerInterval(0);
        }
    ...
    @Test
    public void testSetReadTimerIntervalCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.setReadTimerInterval(0);
        }
    ...
    @Test
    public void testSetReadTimerIntervalCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.setReadTimerInterval(0);
        }
    ...
    @Test
    public void testSetReadTimerIntervalCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setReadTimerInterval(0);
        }
    ...
    @Test
    public void testGetTagCountCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.getTagCount();
        }
    ...
    @Test
    public void testGetTagCountCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.getTagCount();
        }
    ...
    @Test
    public void testGetTagCountCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.getTagCount();
        }
    ...
    @Test
    public void testGetTagCountCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.getTagCount();
        }
    ...
    @Test
    public void testGetTagCountCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getTagCount();
        }
    ...
    @Test
    public void testDisableTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.disableTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testDisableTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.disableTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testDisableTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.disableTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testDisableTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.disableTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testDisableTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.disableTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testFirstTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.firstTag();
        }
    ...
    @Test
    public void testFirstTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.firstTag();
        }
    ...
    @Test
    public void testFirstTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.firstTag();
        }
    ...
    @Test
    public void testFirstTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.firstTag();
        }
    ...
    @Test
    public void testFirstTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.firstTag();
        }
    ...
    @Test
    public void testLockTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.lockTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testLockTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.lockTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testLockTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.lockTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testLockTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.lockTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testLockTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.lockTag(new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testNextTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.nextTag();
        }
    ...
    @Test
    public void testNextTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.nextTag();
        }
    ...
    @Test
    public void testNextTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.nextTag();
        }
    ...
    @Test
    public void testNextTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.nextTag();
        }
    ...
    @Test
    public void testNextTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.nextTag();
        }
    ...
    @Test
    public void testPreviousTagCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.previousTag();
        }
    ...
    @Test
    public void testPreviousTagCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.previousTag();
        }
    ...
    @Test
    public void testPreviousTagCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.previousTag();
        }
    ...
    @Test
    public void testPreviousTagCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.previousTag();
        }
    ...
    @Test
    public void testPreviousTagCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.previousTag();
        }
    ...
    @Test
    public void testReadTagsCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
        }
    ...
    @Test
    public void testReadTagsCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
        }
    ...
    @Test
    public void testReadTagsCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
        }
    ...
    @Test
    public void testReadTagsCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
        }
    ...
    @Test
    public void testReadTagsCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.readTags(0,new byte[0],new byte[0],0,0,0,new byte[0]);
        }
    ...
    @Test
    public void testStartReadTagsCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testStartReadTagsCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testStartReadTagsCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testStartReadTagsCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testStartReadTagsCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startReadTags(0,new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testStopReadTagsCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.stopReadTags(new byte[0]);
        }
    ...
    @Test
    public void testStopReadTagsCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.stopReadTags(new byte[0]);
        }
    ...
    @Test
    public void testStopReadTagsCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.stopReadTags(new byte[0]);
        }
    ...
    @Test
    public void testStopReadTagsCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.stopReadTags(new byte[0]);
        }
    ...
    @Test
    public void testStopReadTagsCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopReadTags(new byte[0]);
        }
    ...
    @Test
    public void testWriteTagDataCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagDataCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagDataCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagDataCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagDataCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.writeTagData(new byte[0],new byte[0],0,0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagIDCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_112);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagIDCalledOnServiceVersion113() {
        try {
            this.control.open(OPENNAME_SERVICE_113);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagIDCalledOnServiceVersion114() {
        try {
            this.control.open(OPENNAME_SERVICE_114);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagIDCalledOnServiceVersion115() {
        try {
            this.control.open(OPENNAME_SERVICE_115);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
        }
    ...
    @Test
    public void testWriteTagIDCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.writeTagID(new byte[0],new byte[0],0,new byte[0]);
        }
