...
public class HardTotalsTest {
    ...
    private static final String OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "HardTotalsTestServiceRethrowingJposException";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("HardTotals", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.14"));
