...
/**
 * DeviceMonitor device control JUnit test.
 * <br>
...
public class DeviceMonitorTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "DeviceMonitorTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "DeviceMonitorTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "DeviceMonitorTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "DeviceMonitorTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "DeviceMonitorTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("DeviceMonitor", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("DeviceMonitor", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("DeviceMonitor", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("DeviceMonitor", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("DeviceMonitor", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private DeviceMonitor control;

    @Before
    public void setUp() throws Exception {
        this.control = new DeviceMonitor();
    }
    ...
    /**
     * Test method for {@link jpos.DeviceMonitor#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS DeviceMonitor Device Control"));
    }
    ...
    @Test
    public final void testGetDeviceDataFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getDeviceData();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetDeviceListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getDeviceList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetMonitoringDeviceListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getMonitoringDeviceList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testAddMonitoringDeviceFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.addMonitoringDevice("",0,0,0,0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testClearMonitoringDevicesFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.clearMonitoringDevices();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testDeleteMonitoringDeviceFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.deleteMonitoringDevice("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetDeviceValueFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getDeviceValue("",new int[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetDeviceDataFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getDeviceData();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getDeviceList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetMonitoringDeviceListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getMonitoringDeviceList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testAddMonitoringDeviceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.addMonitoringDevice("",0,0,0,0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testClearMonitoringDevicesFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.clearMonitoringDevices();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testDeleteMonitoringDeviceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.deleteMonitoringDevice("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceValueFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getDeviceValue("",new int[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceDataRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getDeviceData();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getDeviceList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetMonitoringDeviceListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getMonitoringDeviceList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testAddMonitoringDeviceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.addMonitoringDevice("",0,0,0,0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testClearMonitoringDevicesRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.clearMonitoringDevices();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testDeleteMonitoringDeviceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.deleteMonitoringDevice("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetDeviceValueRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getDeviceValue("",new int[0]);
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("DeviceMonitor.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetDeviceDataCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDeviceData();
        }
    ...
    @Test
    public void testGetDeviceListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDeviceList();
        }
    ...
    @Test
    public void testGetMonitoringDeviceListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getMonitoringDeviceList();
        }
    ...
    @Test
    public void testAddMonitoringDeviceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.addMonitoringDevice("",0,0,0,0);
        }
    ...
    @Test
    public void testClearMonitoringDevicesCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.clearMonitoringDevices();
        }
    ...
    @Test
    public void testDeleteMonitoringDeviceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.deleteMonitoringDevice("");
        }
    ...
    @Test
    public void testGetDeviceValueCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getDeviceValue("",new int[0]);
        }
