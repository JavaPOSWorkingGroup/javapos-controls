...
public class MotionSensorTest {
    ...
    private static final String OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "MotionSensorTestServiceRethrowingJposException";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("MotionSensor", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.14"));
