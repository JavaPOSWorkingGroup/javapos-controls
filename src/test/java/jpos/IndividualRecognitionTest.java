...
/**
 * IndividualRecognition device control JUnit test.
 * <br>
 * Generated through jpos.build.controls.JavaPOSDeviceControlTestGenerator for JavaPOS version 1.16
 */
public class IndividualRecognitionTest {

    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "IndividualRecognitionTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "IndividualRecognitionTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "IndividualRecognitionTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "IndividualRecognitionTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "IndividualRecognitionTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("IndividualRecognition", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("IndividualRecognition", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("IndividualRecognition", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("IndividualRecognition", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("IndividualRecognition", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private IndividualRecognition control;

    @Before
    public void setUp() throws Exception {
        this.control = new IndividualRecognition();
    }
    ...
    /**
     * Test method for {@link jpos.IndividualRecognition#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS IndividualRecognition Device Control"));
    }
    ...
    @Test
    public final void testGetCapIndividualListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapIndividualList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetIndividualIDsFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getIndividualIDs();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetIndividualRecognitionFilterFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getIndividualRecognitionFilter();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetIndividualRecognitionFilterFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setIndividualRecognitionFilter("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetIndividualRecognitionInformationFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getIndividualRecognitionInformation();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapIndividualListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapIndividualList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualIDsFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getIndividualIDs();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualRecognitionFilterFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getIndividualRecognitionFilter();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetIndividualRecognitionFilterFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setIndividualRecognitionFilter("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualRecognitionInformationFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getIndividualRecognitionInformation();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapIndividualListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapIndividualList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualIDsRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getIndividualIDs();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualRecognitionFilterRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getIndividualRecognitionFilter();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetIndividualRecognitionFilterRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setIndividualRecognitionFilter("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetIndividualRecognitionInformationRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getIndividualRecognitionInformation();
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("IndividualRecognition.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapIndividualListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapIndividualList();
        }
    ...
    @Test
    public void testGetIndividualIDsCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getIndividualIDs();
        }
    ...
    @Test
    public void testGetIndividualRecognitionFilterCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getIndividualRecognitionFilter();
        }
    ...
    @Test
    public void testSetIndividualRecognitionFilterCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setIndividualRecognitionFilter("");
        }
    ...
    @Test
    public void testGetIndividualRecognitionInformationCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getIndividualRecognitionInformation();
        }
