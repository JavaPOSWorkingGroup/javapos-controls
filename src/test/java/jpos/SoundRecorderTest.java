...
/**
 * SoundRecorder device control JUnit test.
 * <br>
...
public class SoundRecorderTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "SoundRecorderTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "SoundRecorderTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "SoundRecorderTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "SoundRecorderTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "SoundRecorderTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundRecorder", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundRecorder", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundRecorder", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundRecorder", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SoundRecorder", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private SoundRecorder control;

    @Before
    public void setUp() throws Exception {
        this.control = new SoundRecorder();
    }
    ...
    /**
     * Test method for {@link jpos.SoundRecorder#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS SoundRecorder Device Control"));
    }
    ...
    @Test
    public final void testGetCapChannelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapChannel();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapRecordingLevelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapRecordingLevel();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapSamplingRateFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapSamplingRate();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapSoundTypeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapSoundType();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetChannelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getChannel();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetChannelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setChannel("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetChannelListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getChannelList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetRecordingLevelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getRecordingLevel();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetRecordingLevelFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setRecordingLevel(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSamplingRateFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSamplingRate();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetSamplingRateFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setSamplingRate("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSamplingRateListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSamplingRateList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSoundDataFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSoundData();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSoundTypeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSoundType();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetSoundTypeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setSoundType("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSoundTypeListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSoundTypeList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartRecordingFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startRecording("",true,0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopRecordingFailsWithClosedExceptionBeforeOpen() {
        try {
    ...
    @Test
    public final void testGetCapChannelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapChannel();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapRecordingLevelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapRecordingLevel();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSamplingRateFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapSamplingRate();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSoundTypeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapSoundType();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetChannelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getChannel();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetChannelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setChannel("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetChannelListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getChannelList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetRecordingLevelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getRecordingLevel();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetRecordingLevelFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setRecordingLevel(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSamplingRateFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSamplingRate();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetSamplingRateFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setSamplingRate("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSamplingRateListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSamplingRateList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundDataFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSoundData();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundTypeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSoundType();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetSoundTypeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setSoundType("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundTypeListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSoundTypeList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartRecordingFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startRecording("",true,0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopRecordingFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopRecording();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapChannelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapChannel();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapRecordingLevelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapRecordingLevel();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSamplingRateRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapSamplingRate();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSoundTypeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapSoundType();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetChannelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getChannel();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetChannelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setChannel("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetChannelListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getChannelList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetRecordingLevelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getRecordingLevel();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetRecordingLevelRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setRecordingLevel(0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSamplingRateRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSamplingRate();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetSamplingRateRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setSamplingRate("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSamplingRateListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSamplingRateList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundDataRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSoundData();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundTypeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSoundType();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetSoundTypeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setSoundType("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSoundTypeListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSoundTypeList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartRecordingRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startRecording("",true,0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopRecordingRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopRecording();
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("SoundRecorder.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapChannelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapChannel();
        }
    ...
    @Test
    public void testGetCapRecordingLevelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapRecordingLevel();
        }
    ...
    @Test
    public void testGetCapSamplingRateCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapSamplingRate();
        }
    ...
    @Test
    public void testGetCapSoundTypeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapSoundType();
        }
    ...
    @Test
    public void testGetChannelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getChannel();
        }
    ...
    @Test
    public void testSetChannelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setChannel("");
        }
    ...
    @Test
    public void testGetChannelListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getChannelList();
        }
    ...
    @Test
    public void testGetRecordingLevelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getRecordingLevel();
        }
    ...
    @Test
    public void testSetRecordingLevelCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setRecordingLevel(0);
        }
    ...
    @Test
    public void testGetSamplingRateCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSamplingRate();
        }
    ...
    @Test
    public void testSetSamplingRateCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setSamplingRate("");
        }
    ...
    @Test
    public void testGetSamplingRateListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSamplingRateList();
        }
    ...
    @Test
    public void testGetSoundDataCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSoundData();
        }
    ...
    @Test
    public void testGetSoundTypeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSoundType();
        }
    ...
    @Test
    public void testSetSoundTypeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setSoundType("");
        }
    ...
    @Test
    public void testGetSoundTypeListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSoundTypeList();
        }
    ...
    @Test
    public void testStartRecordingCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startRecording("",true,0);
        }
    ...
    @Test
    public void testStopRecordingCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopRecording();
        }
