...
/**
 * SpeechSynthesis device control JUnit test.
 * <br>
...
public class SpeechSynthesisTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "SpeechSynthesisTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "SpeechSynthesisTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "SpeechSynthesisTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "SpeechSynthesisTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "SpeechSynthesisTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SpeechSynthesis", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SpeechSynthesis", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SpeechSynthesis", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SpeechSynthesis", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("SpeechSynthesis", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private SpeechSynthesis control;

    @Before
    public void setUp() throws Exception {
        this.control = new SpeechSynthesis();
    }
    ...
    /**
     * Test method for {@link jpos.SpeechSynthesis#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS SpeechSynthesis Device Control"));
    }
    ...
    @Test
    public final void testGetCapSpeedFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapSpeed();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapVoiceFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapVoice();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetLanguageFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getLanguage();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetLanguageFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setLanguage("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetLanguageListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getLanguageList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetOutputIDListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getOutputIDList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetPitchFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getPitch();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetPitchFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setPitch(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetSpeedFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getSpeed();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetVoiceFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getVoice();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetVoiceFailsWithClosedExceptionBeforeOpen() {
        try {
    ...
    @Test
    public final void testGetVoiceListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getVoiceList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetVolumeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getVolume();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetVolumeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setVolume(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSpeakFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.speak("");
            fail("CLOSED JposException expected but not thrown");
        }
    ...
    @Test
    public final void testSpeakImmediateFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.speakImmediate("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopCurrentSpeakingFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopCurrentSpeaking();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopSpeakingFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopSpeaking(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapSpeedFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapSpeed();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapVoiceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapVoice();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetLanguageFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getLanguage();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetLanguageFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setLanguage("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetLanguageListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getLanguageList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetOutputIDListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getOutputIDList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetPitchFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getPitch();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetPitchFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setPitch(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetSpeedFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getSpeed();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetVoiceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getVoice();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetVoiceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setVoice("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetVoiceListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getVoiceList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetVolumeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getVolume();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetVolumeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setVolume(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSpeakFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.speak("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSpeakImmediateFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.speakImmediate("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopCurrentSpeakingFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopCurrentSpeaking();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopSpeakingFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopSpeaking(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapSpeedRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapSpeed();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapVoiceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapVoice();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetLanguageRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getLanguage();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetLanguageRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setLanguage("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetLanguageListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getLanguageList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetOutputIDListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getOutputIDList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetPitchRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getPitch();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetPitchRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setPitch(0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetSpeedRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getSpeed();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetVoiceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getVoice();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetVoiceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setVoice("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetVoiceListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getVoiceList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetVolumeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getVolume();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetVolumeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setVolume(0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSpeakRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.speak("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSpeakImmediateRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.speakImmediate("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopCurrentSpeakingRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopCurrentSpeaking();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopSpeakingRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopSpeaking(0);
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("SpeechSynthesis.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetCapSpeedCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapSpeed();
        }
    ...
    @Test
    public void testGetCapVoiceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapVoice();
        }
    ...
    @Test
    public void testGetLanguageCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getLanguage();
        }
    ...
    @Test
    public void testSetLanguageCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setLanguage("");
        }
    ...
    @Test
    public void testGetLanguageListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getLanguageList();
        }
    ...
    @Test
    public void testGetOutputIDListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getOutputIDList();
        }
    ...
    @Test
    public void testGetPitchCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getPitch();
        }
    ...
    @Test
    public void testSetPitchCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setPitch(0);
        }
    ...
    @Test
    public void testGetSpeedCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getSpeed();
        }
    ...
    @Test
    public void testGetVoiceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getVoice();
        }
    ...
    @Test
    public void testSetVoiceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setVoice("");
        }
    ...
    @Test
    public void testGetVoiceListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getVoiceList();
        }
    ...
    @Test
    public void testGetVolumeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getVolume();
        }
    ...
    @Test
    public void testSetVolumeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setVolume(0);
        }
    ...
    @Test
    public void testSpeakCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.speak("");
        }
    ...
    @Test
    public void testSpeakImmediateCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.speakImmediate("");
        }
    ...
    @Test
    public void testStopCurrentSpeakingCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopCurrentSpeaking();
        }
    ...
    @Test
    public void testStopSpeakingCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopSpeaking(0);
        }
