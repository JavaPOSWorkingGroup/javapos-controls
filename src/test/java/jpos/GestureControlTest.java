...
/**
 * GestureControl device control JUnit test.
 * <br>
...
public class GestureControlTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "GestureControlTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "GestureControlTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "GestureControlTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "GestureControlTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "GestureControlTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("GestureControl", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("GestureControl", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("GestureControl", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("GestureControl", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("GestureControl", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    public void setUp() throws Exception {
        this.control = new GestureControl();
    }
    ...
    /**
     * Test method for {@link jpos.GestureControl#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS GestureControl Device Control"));
    }
    ...
    @Test
    public final void testGetAutoModeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getAutoMode();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
    ...
    @Test
    public final void testSetAutoModeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setAutoMode("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetAutoModeListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getAutoModeList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapMotionFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapMotion();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapMotionCreationFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapMotionCreation();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapPoseFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapPose();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetCapPoseCreationFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getCapPoseCreation();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetJointListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getJointList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetMotionListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getMotionList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetPoseCreationModeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getPoseCreationMode();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetPoseCreationModeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setPoseCreationMode(true);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetPoseListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getPoseList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testCreateMotionFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.createMotion("","");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testCreatePoseFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.createPose("",0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetPositionFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getPosition("",new int[0]);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetPositionFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.setPosition("",0,true);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testSetSpeedFailsWithClosedExceptionBeforeOpen() {
        try {
    ...
    @Test
    public final void testStartMotionFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startMotion("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartPoseFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startPose("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopControlFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopControl(0);
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetAutoModeFailsWithFailureExceptionOnNPE() {
        try {
    ...
    @Test
    public final void testSetAutoModeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setAutoMode("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetAutoModeListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getAutoModeList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMotionFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapMotion();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMotionCreationFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapMotionCreation();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapPoseFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapPose();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapPoseCreationFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getCapPoseCreation();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetJointListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getJointList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetMotionListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getMotionList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetPoseCreationModeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getPoseCreationMode();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetPoseCreationModeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setPoseCreationMode(true);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetPoseListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getPoseList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testCreateMotionFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.createMotion("","");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testCreatePoseFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.createPose("",0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetPositionFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getPosition("",new int[0]);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetPositionFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setPosition("",0,true);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testSetSpeedFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.setSpeed("",0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartMotionFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startMotion("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartPoseFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startPose("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopControlFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopControl(0);
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetAutoModeRethrowsJposException() {
        try {
    ...
    @Test
    public final void testSetAutoModeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setAutoMode("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetAutoModeListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getAutoModeList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMotionRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapMotion();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapMotionCreationRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapMotionCreation();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapPoseRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapPose();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetCapPoseCreationRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getCapPoseCreation();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetJointListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getJointList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetMotionListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getMotionList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetPoseCreationModeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getPoseCreationMode();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetPoseCreationModeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setPoseCreationMode(true);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetPoseListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getPoseList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testCreateMotionRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.createMotion("","");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testCreatePoseRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.createPose("",0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetPositionRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getPosition("",new int[0]);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetPositionRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setPosition("",0,true);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testSetSpeedRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.setSpeed("",0);
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartMotionRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startMotion("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartPoseRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startPose("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopControlRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopControl(0);
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("GestureControl.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    
    
    @Test
    public void testGetAutoModeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getAutoMode();
        }
    ...
    @Test
    public void testSetAutoModeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setAutoMode("");
        }
    ...
    @Test
    public void testGetAutoModeListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getAutoModeList();
        }
    ...
    @Test
    public void testGetCapMotionCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapMotion();
        }
    ...
    @Test
    public void testGetCapMotionCreationCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapMotionCreation();
        }
    ...
    @Test
    public void testGetCapPoseCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapPose();
        }
    ...
    @Test
    public void testGetCapPoseCreationCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getCapPoseCreation();
        }
    ...
    @Test
    public void testGetJointListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getJointList();
        }
    ...
    @Test
    public void testGetMotionListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getMotionList();
        }
    ...
    @Test
    public void testGetPoseCreationModeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getPoseCreationMode();
        }
    ...
    @Test
    public void testSetPoseCreationModeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setPoseCreationMode(true);
        }
    ...
    @Test
    public void testGetPoseListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getPoseList();
        }
    ...
    @Test
    public void testCreateMotionCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.createMotion("","");
        }
    ...
    @Test
    public void testCreatePoseCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.createPose("",0);
        }
    ...
    @Test
    public void testGetPositionCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getPosition("",new int[0]);
        }
    ...
    @Test
    public void testSetPositionCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setPosition("",0,true);
        }
    ...
    @Test
    public void testSetSpeedCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setSpeed("",0);
        }
    ...
    @Test
    public void testStartMotionCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startMotion("");
        }
    ...
    @Test
    public void testStartPoseCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startPose("");
        }
    ...
    @Test
    public void testStopControlCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopControl(0);
        }
