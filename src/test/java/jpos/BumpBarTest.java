...
public class BumpBarTest {
    ...
    private static final String SERVICE_116 = "BumpBarTestService116";
    ...
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "BumpBarTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("BumpBar", OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE, "1.15", SERVICE_115, new SimpleEntry.Prop("returnVersionTooLarge", "")));
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS BumpBar Device Control"));
    }
    ...
    @Test
    public void testGetBumpBarDataCountCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getBumpBarDataCount();
        }
    ...
    @Test
    public void testGetKeysCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getKeys();
        }
    ...
    @Test
    public void testBumpBarSoundCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.bumpBarSound(0,0,0,0,0);
        }
    ...
    @Test
    public void testSetKeyTranslationCalledOnServiceVersion116() {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.setKeyTranslation(0,0,0);
        }
