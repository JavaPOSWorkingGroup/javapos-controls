...
/**
 * VoiceRecognition device control JUnit test.
 * <br>
...
public class VoiceRecognitionTest {
    ...
    private static final String SERVICE_ALL_METHODS_THROWING_NPE = "VoiceRecognitionTestServiceAlwaysThrowingNPE";
    private static final String SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "VoiceRecognitionTestServiceRethrowingJposException";
    private static final String SERVICE_116 = "VoiceRecognitionTestService116";
    ...
    private static final String OPENNAME_SERVICE_116_RETURNING_VERSION_TOO_LARGE = "VoiceRecognitionTestService116ReturningVersionTooLarge";
    private static final String OPENNAME_SERVICE_115_RETURNING_VERSION_TOO_LARGE = "VoiceRecognitionTestService115ReturningVersionTooLarge";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("VoiceRecognition", OPENNAME_WITH_NOT_EXISTING_SERVICECLASS, "1.16", "NotExistingServiceClass"));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("VoiceRecognition", OPENNAME_ALL_METHODS_THROWING_NPE, "1.16", SERVICE_ALL_METHODS_THROWING_NPE));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("VoiceRecognition", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.16", SERVICE_ALL_METHODS_RETHROWING_JPOSEXCEPTION));
        registry.addJposEntry(ControlsTestHelper.createJposEntry("VoiceRecognition", OPENNAME_THROWING_NPE_ON_GETDSVERSION, "1.116", SERVICE_116, new SimpleEntry.Prop("throwingNPEOnGetDSVersion", "")));
        
        registry.addJposEntry(ControlsTestHelper.createJposEntry("VoiceRecognition", OPENNAME_SERVICE_116, "1.16", SERVICE_116));
    ...
    private VoiceRecognition control;

    @Before
    public void setUp() throws Exception {
        this.control = new VoiceRecognition();
    }
    ...
    /**
     * Test method for {@link jpos.VoiceRecognition#createEventCallbacks()}.
     */
    @Test
    ...
    public void testGetDeviceControlDescription() throws Exception {
        assertThat(this.control.getDeviceControlDescription(), is("JavaPOS VoiceRecognition Device Control"));
    }
    ...
    @Test
    public final void testGetHearingDataPatternFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getHearingDataPattern();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetHearingDataWordFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getHearingDataWord();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetHearingDataWordListFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getHearingDataWordList();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetHearingResultFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getHearingResult();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetHearingStatusFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.getHearingStatus();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartHearingFreeFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startHearingFree("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartHearingSentenceFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startHearingSentence("","","");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartHearingWordFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startHearingWord("","");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStartHearingYesNoFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.startHearingYesNo("");
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testStopHearingFailsWithClosedExceptionBeforeOpen() {
        try {
            this.control.stopHearing();
            fail("CLOSED JposException expected but not thrown");
        }
        catch (JposException e) {
            assertThat("CLOSED JposException expected but a different was thrown: " + e.getErrorCode(), e.getErrorCode(), is(JposConst.JPOS_E_CLOSED));
    ...
    @Test
    public final void testGetHearingDataPatternFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getHearingDataPattern();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingDataWordFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getHearingDataWord();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingDataWordListFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getHearingDataWordList();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingResultFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getHearingResult();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingStatusFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.getHearingStatus();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingFreeFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startHearingFree("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingSentenceFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startHearingSentence("","","");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingWordFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startHearingWord("","");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingYesNoFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.startHearingYesNo("");
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testStopHearingFailsWithFailureExceptionOnNPE() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_THROWING_NPE);
            this.control.stopHearing();
            fail("FAILURE JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingDataPatternRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getHearingDataPattern();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingDataWordRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getHearingDataWord();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingDataWordListRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getHearingDataWordList();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingResultRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getHearingResult();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testGetHearingStatusRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.getHearingStatus();
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingFreeRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startHearingFree("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingSentenceRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startHearingSentence("","","");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingWordRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startHearingWord("","");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStartHearingYesNoRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.startHearingYesNo("");
            fail("JposException expected but not thrown");
    ...
    @Test
    public final void testStopHearingRethrowsJposException() {
        try {
            this.control.open(OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION);
            this.control.stopHearing();
            fail("JposException expected but not thrown");
    ...
    public final void testGetDeviceVersion116() {
        try {
            ...
            fail("VoiceRecognition.getDeviceServiceVersion() failed with " + e.getMessage());
        }
    }
    ...
    @Test
    public void testGetHearingDataPatternCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getHearingDataPattern();
        }
    ...
    @Test
    public void testGetHearingDataWordCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getHearingDataWord();
        }
    ...
    @Test
    public void testGetHearingDataWordListCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getHearingDataWordList();
        }
    ...
    @Test
    public void testGetHearingResultCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getHearingResult();
        }
    ...
    @Test
    public void testGetHearingStatusCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.getHearingStatus();
        }
    ...
    @Test
    public void testStartHearingFreeCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startHearingFree("");
        }
    ...
    @Test
    public void testStartHearingSentenceCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startHearingSentence("","","");
        }
    ...
    @Test
    public void testStartHearingWordCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startHearingWord("","");
        }
    ...
    @Test
    public void testStartHearingYesNoCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.startHearingYesNo("");
        }
    ...
    @Test
    public void testStopHearingCalledOnServiceVersionWhenAdded() throws Exception {
        try {
            this.control.open(OPENNAME_SERVICE_116);
            this.control.stopHearing();
        }
