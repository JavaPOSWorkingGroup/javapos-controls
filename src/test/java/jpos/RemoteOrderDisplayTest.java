...
public class RemoteOrderDisplayTest {
    ...
    private static final String OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION = "RemoteOrderDisplayTestServiceRethrowingJposException";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        registry.addJposEntry(ControlsTestHelper.createJposEntry("RemoteOrderDisplay", OPENNAME_ALL_METHODS_RETHROWING_JPOSEXCEPTION, "1.14"));
