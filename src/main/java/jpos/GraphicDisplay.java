...
//
// GraphicDisplay.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class GraphicDisplay
    ...
    implements GraphicDisplayControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------

    protected GraphicDisplayService116 service116;
    ...
    public GraphicDisplay()
    {
        ...
        deviceControlDescription = "JavaPOS GraphicDisplay Device Control";
    ...
    public boolean getCapImageType()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getCapImageType();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getCapURLBack();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public boolean getCapURLForward()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getCapURLForward();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getDisplayMode();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            service116.setDisplayMode(newValue);
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getImageType();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public void setImageType(String newValue)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            service116.setImageType(newValue);
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getImageTypeList();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getLoadStatus();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public void playVideo(String fileName, boolean loop)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            service116.playVideo(fileName, loop);
        }
        catch(JposException je)
        {
            throw je;
    ...
    {
      return new GraphicDisplayCallbacks();
    }
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (GraphicDisplayService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement GraphicDisplayService116 interface",
                                            e);
                }
            }
    ...
    protected class GraphicDisplayCallbacks
        implements EventCallbacks
    {
        public BaseControl getEventSource()
        {
            return (BaseControl)GraphicDisplay.this;
        }
        ...
        {
            synchronized(GraphicDisplay.this.directIOListeners)
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : GraphicDisplay.this.directIOListeners) {
        ...
        {
            synchronized(GraphicDisplay.this.errorListeners)
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : GraphicDisplay.this.errorListeners) {
        ...
        {
            synchronized(GraphicDisplay.this.statusUpdateListeners)
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : GraphicDisplay.this.statusUpdateListeners) {
        ...
        {
            synchronized(GraphicDisplay.this.outputCompleteListeners)
            {
                // deliver the event to all registered listeners
                for (OutputCompleteListener outputCompleteListener : GraphicDisplay.this.outputCompleteListeners) {
