    ...
    implements ElectronicValueRWControl115, JposConst
{
    ...
    public boolean getCapMembershipCertificate()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void accessData(int dataType, int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void activateEVService(int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void checkServiceRegistrationToMedium(int sequenceNumber, int timeout)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void closeDailyEVService(int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void deactivateEVService(int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void openDailyEVService(int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void registerServiceToMedium(int sequenceNumber, int timeout)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void unregisterServiceToMedium(int sequenceNumber, int timeout)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
    ...
    public void updateData(int dataType, int[] data, Object[] obj)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
