...
//
// PointCardRW.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class PointCardRW
    ...
    implements PointCardRWControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected PointCardRWService115 service115;
    protected PointCardRWService116 service116;
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion115)
            {
                try
                {
                    service115 = (PointCardRWService115)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement PointCardRWService115 interface",
                                            e);
                }
            }
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (PointCardRWService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement PointCardRWService116 interface",
                                            e);
                }
            }
        ...
        implements EventCallbacks
    {
        ...
        public void fireDataEvent(DataEvent e)
        {
            synchronized(PointCardRW.this.dataListeners)
            {
                ...
                for (DataListener dataListener : PointCardRW.this.dataListeners) {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : PointCardRW.this.directIOListeners) {
        ...
        public void fireErrorEvent(ErrorEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : PointCardRW.this.errorListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : PointCardRW.this.statusUpdateListeners) {
        ...
        public void fireOutputCompleteEvent(OutputCompleteEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (OutputCompleteListener outputCompleteListener : PointCardRW.this.outputCompleteListeners) {
