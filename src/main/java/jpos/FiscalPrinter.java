...
//
// FiscalPrinter.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class FiscalPrinter
    ...
    implements FiscalPrinterControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected FiscalPrinterService116 service116;
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (FiscalPrinterService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement FiscalPrinterService116 interface",
                                            e);
                }
            }
        ...
        implements EventCallbacks
    {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            synchronized(FiscalPrinter.this.directIOListeners)
            {
                ...
                for (DirectIOListener directIOListener : FiscalPrinter.this.directIOListeners) {
        ...
        public void fireErrorEvent(ErrorEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : FiscalPrinter.this.errorListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : FiscalPrinter.this.statusUpdateListeners) {
        ...
        public void fireOutputCompleteEvent(OutputCompleteEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (OutputCompleteListener outputCompleteListener : FiscalPrinter.this.outputCompleteListeners) {
