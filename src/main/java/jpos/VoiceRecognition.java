...
//
// VoiceRecognition.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class VoiceRecognition
    ...
    implements VoiceRecognitionControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------

    protected VoiceRecognitionService116 service116;
    ...
    public VoiceRecognition()
    {
        ...
        deviceControlDescription = "JavaPOS VoiceRecognition Device Control";
    ...
    public String getHearingDataPattern()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getHearingDataPattern();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public String getHearingDataWord()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getHearingDataWord();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public String getHearingDataWordList()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getHearingDataWordList();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getHearingResult();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getHearingStatus();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            service116.startHearingFree(language);
        }
        catch(JposException je)
        {
            throw je;
    ...
    public void startHearingSentence(String language, String wordList, String patternList)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            service116.startHearingSentence(language, wordList, patternList);
        }
        catch(JposException je)
        {
            throw je;
    ...
    public void startHearingWord(String language, String wordList)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            service116.startHearingWord(language, wordList);
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            service116.startHearingYesNo(language);
        }
        catch(JposException je)
        {
            throw je;
    ...
    {
      return new VoiceRecognitionCallbacks();
    }
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (VoiceRecognitionService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement VoiceRecognitionService116 interface",
                                            e);
                }
            }
    ...
    protected class VoiceRecognitionCallbacks
        implements EventCallbacks
    {
        public BaseControl getEventSource()
        {
            return (BaseControl)VoiceRecognition.this;
        }
        
        public void fireDataEvent(DataEvent e)
        {
            synchronized(VoiceRecognition.this.dataListeners)
            {
                // deliver the event to all registered listeners
                for (DataListener dataListener : VoiceRecognition.this.dataListeners) {
        ...
        {
            synchronized(VoiceRecognition.this.directIOListeners)
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : VoiceRecognition.this.directIOListeners) {
        ...
        {
            synchronized(VoiceRecognition.this.errorListeners)
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : VoiceRecognition.this.errorListeners) {
        ...
        {
            synchronized(VoiceRecognition.this.statusUpdateListeners)
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : VoiceRecognition.this.statusUpdateListeners) {
