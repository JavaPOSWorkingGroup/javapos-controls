...
//
// ToneIndicator.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class ToneIndicator
    ...
    implements ToneIndicatorControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected ToneIndicatorService115 service115;
    protected ToneIndicatorService116 service116;
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion115)
            {
                try
                {
                    service115 = (ToneIndicatorService115)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement ToneIndicatorService115 interface",
                                            e);
                }
            }
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (ToneIndicatorService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement ToneIndicatorService116 interface",
                                            e);
                }
            }
        ...
        implements EventCallbacks
    {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            synchronized(ToneIndicator.this.directIOListeners)
            {
                ...
                for (DirectIOListener directIOListener : ToneIndicator.this.directIOListeners) {
        ...
        public void fireErrorEvent(ErrorEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : ToneIndicator.this.errorListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : ToneIndicator.this.statusUpdateListeners) {
        ...
        public void fireOutputCompleteEvent(OutputCompleteEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (OutputCompleteListener outputCompleteListener : ToneIndicator.this.outputCompleteListeners) {
