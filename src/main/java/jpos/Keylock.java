    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion115)
            {
                try
                {
                    service115 = (KeylockService115)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
        ...
        implements EventCallbacks
    {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            synchronized(Keylock.this.directIOListeners)
            {
                ...
                for (DirectIOListener directIOListener : Keylock.this.directIOListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : Keylock.this.statusUpdateListeners) {
