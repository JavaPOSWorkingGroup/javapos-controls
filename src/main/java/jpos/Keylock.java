...
//
// Keylock.java - A JavaPOS 1.6.0 device control
//
//------------------------------------------------------------------------------
...
public class Keylock
   implements KeylockControl16, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected static final String deviceControlDescription =
                                    "JavaPOS Keylock Device Control";
        ...
        throws JposException
    {
        ...
        else
        {
            throw new JposException(JPOS_E_NOSERVICE,
                                    "Service does not support the KeylockControl13 interface");
        }
    }
        ...
        throws JposException
    {
        ...
        try
        {
            service12 = (KeylockService12)serviceConnection.getService();
        }
        catch(Exception e)
        {
            throw new JposException(JPOS_E_NOSERVICE,
        ...
        if(serviceVersion >= deviceVersion13)
        {
            try
            {
                service13 = (KeylockService13)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement KeylockDevice13 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion14)
        {
            try
            {
                service14 = (KeylockService14)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement KeylockDevice14 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion15)
        {
            try
            {
                service15 = (KeylockService15)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement KeylockDevice15 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion16)
        {
            try
            {
                service16 = (KeylockService16)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement KeylockDevice16 interface",
                                        e);
            }
        }

        // Create callback subclass and attach it to the device service
        KeylockCallbacks callbacks = this.new KeylockCallbacks();
