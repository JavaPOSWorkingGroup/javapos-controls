...
//
// Scale.java - A JavaPOS 1.6.0 device control
//
//------------------------------------------------------------------------------
...
public class Scale
   implements ScaleControl16, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
        ...
        throws JposException
    {
        ...
        else
        {
            throw new JposException(JPOS_E_NOSERVICE,
                                    "Service does not support the ScaleControl13 interface");
        }
    }
        ...
        throws JposException
    {
        ...
        try
        {
            service12 = (ScaleService12)serviceConnection.getService();
        }
        catch(Exception e)
        {
            throw new JposException(JPOS_E_NOSERVICE,
        ...
        if(serviceVersion >= deviceVersion13)
        {
            try
            {
                service13 = (ScaleService13)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement ScaleDevice13 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion14)
        {
            try
            {
                service14 = (ScaleService14)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement ScaleDevice14 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion15)
        {
            try
            {
                service15 = (ScaleService15)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement ScaleDevice15 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion16)
        {
            try
            {
                service16 = (ScaleService16)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement ScaleDevice16 interface",
                                        e);
            }
        }

        // Create callback subclass and attach it to the device service
        ScaleCallbacks callbacks = this.new ScaleCallbacks();
