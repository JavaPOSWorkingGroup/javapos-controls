...
//
// POSKeyboard.java - A JavaPOS 1.6.0 device control
//
//------------------------------------------------------------------------------
...
public class POSKeyboard
   implements POSKeyboardControl16, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected static final String deviceControlDescription =
                                    "JavaPOS POSKeyboard Device Control";
        ...
        throws JposException
    {
        ...
        else
        {
            throw new JposException(JPOS_E_NOSERVICE,
                                    "Service does not support the POSKeyboardControl13 interface");
        }
    }
        ...
        throws JposException
    {
        ...
        try
        {
            service12 = (POSKeyboardService12)serviceConnection.getService();
        }
        catch(Exception e)
        {
            throw new JposException(JPOS_E_NOSERVICE,
        ...
        if(serviceVersion >= deviceVersion13)
        {
            try
            {
                service13 = (POSKeyboardService13)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement POSKeyboardDevice13 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion14)
        {
            try
            {
                service14 = (POSKeyboardService14)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement POSKeyboardDevice14 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion15)
        {
            try
            {
                service15 = (POSKeyboardService15)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement POSKeyboardDevice15 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion16)
        {
            try
            {
                service16 = (POSKeyboardService16)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement POSKeyboardDevice16 interface",
                                        e);
            }
        }

        // Create callback subclass and attach it to the device service
        POSKeyboardCallbacks callbacks = this.new POSKeyboardCallbacks();
