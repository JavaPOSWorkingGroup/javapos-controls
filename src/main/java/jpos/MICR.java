...
//
// MICR.java - A JavaPOS 1.6.0 device control
//
//------------------------------------------------------------------------------
...
public class MICR
   implements MICRControl16, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
        ...
        throws JposException
    {
        ...
        else
        {
            throw new JposException(JPOS_E_NOSERVICE,
                                    "Service does not support the MICRControl13 interface");
        }
    }
        ...
        throws JposException
    {
        ...
        try
        {
            service12 = (MICRService12)serviceConnection.getService();
        }
        catch(Exception e)
        {
            throw new JposException(JPOS_E_NOSERVICE,
        ...
        if(serviceVersion >= deviceVersion13)
        {
            try
            {
                service13 = (MICRService13)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement MICRDevice13 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion14)
        {
            try
            {
                service14 = (MICRService14)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement MICRDevice14 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion15)
        {
            try
            {
                service15 = (MICRService15)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement MICRDevice15 interface",
                                        e);
            }
        }
        ...
        if(serviceVersion >= deviceVersion16)
        {
            try
            {
                service16 = (MICRService16)service12;
            }
            catch(Exception e)
            {
                throw new JposException(JPOS_E_NOSERVICE,
                                        "Service does not fully implement MICRDevice16 interface",
                                        e);
            }
        }

        // Create callback subclass and attach it to the device service
        MICRCallbacks callbacks = this.new MICRCallbacks();
