    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion115)
            {
                try
                {
                    service115 = (ImageScannerService115)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
        ...
        implements EventCallbacks
    {
        ...
        public void fireDataEvent(DataEvent e)
        {
            synchronized(ImageScanner.this.dataListeners)
            {
                ...
                for (DataListener dataListener : ImageScanner.this.dataListeners) {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : ImageScanner.this.directIOListeners) {
        ...
        public void fireErrorEvent(ErrorEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : ImageScanner.this.errorListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : ImageScanner.this.statusUpdateListeners) {
