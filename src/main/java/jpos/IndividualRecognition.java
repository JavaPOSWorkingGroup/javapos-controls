...
//
// IndividualRecognition.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class IndividualRecognition
    ...
    implements IndividualRecognitionControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------

    protected IndividualRecognitionService116 service116;
    ...
    public IndividualRecognition()
    {
        ...
        deviceControlDescription = "JavaPOS IndividualRecognition Device Control";
    ...
    public String getCapIndividualList()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getCapIndividualList();
        }
        catch(JposException je)
        {
            throw je;
        ...
        throws JposException
    {
        ...
        try
        {
            return service116.getIndividualIDs();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public String getIndividualRecognitionFilter()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getIndividualRecognitionFilter();
        }
        catch(JposException je)
        {
            throw je;
    ...
    public void setIndividualRecognitionFilter(String newValue)
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            service116.setIndividualRecognitionFilter(newValue);
        }
        catch(JposException je)
        {
            throw je;
    ...
    public String getIndividualRecognitionInformation()
        throws JposException
    {
        // Make sure control is opened
        if(!bOpen)
        ...
        try
        {
            return service116.getIndividualRecognitionInformation();
        }
        catch(JposException je)
        {
            throw je;
    ...
    {
      return new IndividualRecognitionCallbacks();
    }
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (IndividualRecognitionService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement IndividualRecognitionService116 interface",
                                            e);
                }
            }
    ...
    protected class IndividualRecognitionCallbacks
        implements EventCallbacks
    {
        public BaseControl getEventSource()
        {
            return (BaseControl)IndividualRecognition.this;
        }
        
        public void fireDataEvent(DataEvent e)
        {
            synchronized(IndividualRecognition.this.dataListeners)
            {
                // deliver the event to all registered listeners
                for (DataListener dataListener : IndividualRecognition.this.dataListeners) {
        ...
        {
            synchronized(IndividualRecognition.this.directIOListeners)
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : IndividualRecognition.this.directIOListeners) {
        ...
        {
            synchronized(IndividualRecognition.this.errorListeners)
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : IndividualRecognition.this.errorListeners) {
        ...
        {
            synchronized(IndividualRecognition.this.statusUpdateListeners)
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : IndividualRecognition.this.statusUpdateListeners) {
