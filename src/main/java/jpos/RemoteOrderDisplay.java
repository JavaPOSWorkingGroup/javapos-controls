    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion115)
            {
                try
                {
                    service115 = (RemoteOrderDisplayService115)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
        ...
        implements EventCallbacks
    {
        ...
        public void fireDataEvent(DataEvent e)
        {
            synchronized(RemoteOrderDisplay.this.dataListeners)
            {
                ...
                for (DataListener dataListener : RemoteOrderDisplay.this.dataListeners) {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (DirectIOListener directIOListener : RemoteOrderDisplay.this.directIOListeners) {
        ...
        public void fireErrorEvent(ErrorEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (ErrorListener errorListener : RemoteOrderDisplay.this.errorListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : RemoteOrderDisplay.this.statusUpdateListeners) {
        ...
        public void fireOutputCompleteEvent(OutputCompleteEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (OutputCompleteListener outputCompleteListener : RemoteOrderDisplay.this.outputCompleteListeners) {
