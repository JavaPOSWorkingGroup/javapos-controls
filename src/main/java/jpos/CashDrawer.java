...
//
// CashDrawer.java - A JavaPOS 1.16.0 device control
//
//------------------------------------------------------------------------------
...
public class CashDrawer
    ...
    implements CashDrawerControl116, JposConst
{
    //--------------------------------------------------------------------------
    // Variables
    //--------------------------------------------------------------------------
    ...
    protected CashDrawerService116 service116;
    ...
    throws JposException
    {
        ...
        else
        {
            ...
            if(serviceVersion >= deviceVersion116)
            {
                try
                {
                    service116 = (CashDrawerService116)service;
                }
                catch(Exception e)
                {
                    throw new JposException(JPOS_E_NOSERVICE,
                                            "Service does not fully implement CashDrawerService116 interface",
                                            e);
                }
            }
        ...
        implements EventCallbacks
    {
        ...
        public void fireDirectIOEvent(DirectIOEvent e)
        {
            synchronized(CashDrawer.this.directIOListeners)
            {
                ...
                for (DirectIOListener directIOListener : CashDrawer.this.directIOListeners) {
        ...
        public void fireStatusUpdateEvent(StatusUpdateEvent e)
        {
            ...
            {
                // deliver the event to all registered listeners
                for (StatusUpdateListener statusUpdateListener : CashDrawer.this.statusUpdateListeners) {
